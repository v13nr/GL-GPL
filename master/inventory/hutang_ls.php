...
<input type="hidden" name="cmd" value="" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="index.php?mn=pembelian"><img src="../draft/images/user_add.png" width="32" height="32" border="0" align="absbottom" class="style3" /></a></div></td>
...
//		$SQL = $SQL." ORDER BY norek ASC";
    ...
    <tr <?	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<? }  else {?>bgcolor="#FFFFCC"<? } ?>>
	  ...
	  { ?>
      <a href="javascript:void(0)" onclick='showx("inventory/pembelian_edit.php?sub=<?=$row['sub']?>&nomor=<?=$row['nomor']?>&supp=<?=$row['kode']?>","#content")' ><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  <? } ?>
	  </div></td>
    </tr>
	<?  
