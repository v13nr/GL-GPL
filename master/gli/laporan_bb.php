...
<table width="578" align="center" cellspacing="1" bgcolor="#000000">
	...
	<tr bgcolor="#FFFFCC">
		<td width="87">Periode</td>
		<td width="105"><input type="text" name="tgl_awal" id="tgl_awal" size="10" class="required" title="Harap Mengisi Tanggal Awal Dahulu" />
      <a href="javascript:showCalendar('tgl_awal')"><img src="../assets/kalendar_files/calendar_icon.gif" border="0" /></a></td>
		...
		<td width="68">Divisi</td>
		<td width="240"><select name="divisi">
	...
	<tr bgcolor="#FFFFCC">
		<td>S/d</td>
		<td><input type="text" name="tgl_akhir" id="tgl_akhir" size="10" class="required" title="Harap Mengisi Tanggal Akhir Dahulu" value="<?=$_GET['tgl_transaksi']?>" />
          <a href="javascript:showCalendar('tgl_akhir')"><img src="../assets/kalendar_files/calendar_icon.gif" border="0" /></a></td>
		<td>No. Rek </td>
		<td><select name="norek" class="" title="Pilih Nomor Rekening Dahulu" >
          <option value="">-ALL-</option>
          <?
