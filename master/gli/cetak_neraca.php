...
//1. loop rek
$SQLrek = "SELECT * FROM dbfm WHERE status = 1";
...
while($barisrek = mysql_fetch_array($hasilrek)) {
	...
	//2. cari adebet
	$SQLadebet = "SELECT SUM(jumlah) FROM dbfj WHERE kd = '".$barisrek[0]."' AND tanggal < '".baliktgl($_POST['tgl_awal'])."'";
	if($_POST['divisi']<>""){
	...
	//3. cari akredit
	$SQLakredit = "SELECT SUM(jumlah) FROM dbfj WHERE kk = '".$barisrek[0]."' AND tanggal < '".baliktgl($_POST['tgl_awal'])."'";
	if($_POST['divisi']<>""){
	...
	//debet
	//2. cari adebet
	$SQLadebetd = "SELECT SUM(jumlah) FROM dbfj WHERE kd = '".$barisrek[0]."' AND (tanggal BETWEEN '".baliktgl($_POST['tgl_awal'])."' AND '".baliktgl($_POST['tgl_akhir'])."')";
	if($_POST['divisi']<>""){
	...
	*/
	...
	$SQLadebetk = "SELECT SUM(jumlah) FROM dbfj WHERE kk = '".$barisrek[0]."' AND (tanggal BETWEEN '".baliktgl($_POST['tgl_awal'])."' AND '".baliktgl($_POST['tgl_akhir'])."')";
	if($_POST['divisi']<>""){
