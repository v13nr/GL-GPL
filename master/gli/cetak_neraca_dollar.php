...
while($barisrek = mysql_fetch_array($hasilrek)) {
	...
	//2. cari adebet
	$SQLadebet = "SELECT SUM(dollar) FROM dbfj WHERE kd = '".$barisrek[0]."' AND tanggal < '".baliktgl($_POST['tgl_awal'])."'";
	if($_POST['divisi']<>""){
	...
	//3. cari akredit
	$SQLakredit = "SELECT SUM(dollar) FROM dbfj WHERE kk = '".$barisrek[0]."' AND tanggal < '".baliktgl($_POST['tgl_awal'])."'";
	if($_POST['divisi']<>""){
	...
	//debet
	//2. cari adebet
	$SQLadebetd = "SELECT SUM(dollar) FROM dbfj WHERE kd = '".$barisrek[0]."' AND (tanggal BETWEEN '".baliktgl($_POST['tgl_awal'])."' AND '".baliktgl($_POST['tgl_akhir'])."')";
	if($_POST['divisi']<>""){
	...
	*/
	...
	$SQLadebetk = "SELECT SUM(dollar) FROM dbfj WHERE kk = '".$barisrek[0]."' AND (tanggal BETWEEN '".baliktgl($_POST['tgl_awal'])."' AND '".baliktgl($_POST['tgl_akhir'])."')";
	if($_POST['divisi']<>""){
