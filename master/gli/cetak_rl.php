...
$pdf->cell(190,6,'LAPORAN RUGI LABA', 0, 0, 'C');
$pdf->setY(20);
...
$y = 62;
$sr_passiva = 0;
$SQL = "SELECT * FROM dbfn WHERE tipe = 'R' AND id = '".$a."' ORDER BY norek";
$hasil = mysql_query($SQL);
...
$y = $y + 6; 
$sr_passiva_R2 = 0;
$SQL = "SELECT * FROM dbfn WHERE tipe = 'R2' AND id = '".$a."' ORDER BY norek";
$hasil = mysql_query($SQL);
while($baris = mysql_fetch_array($hasil)){
	$pdf->setY($y);
	//$pdf->cell(8,5,++$no, 1, 0, 'C');
...
$pdf->cell(28,5,number_format($sr_passiva_R2,2,'.',','), 1, 0, 'R');
...
$pdf->cell(28,5,number_format($sa_passiva + $sa_passiva_R2,2,'.',','), 1, 0, 'R');
$pdf->cell(28,5,number_format($d_passiva + $d_passiva_R2,2,'.',','), 1, 0, 'R');
$pdf->cell(28,5,number_format($k_passiva + $k_passiva_R2,2,'.',','), 1, 0, 'R');
