    ...
    <td><form id="pegForm" method="post" name="pegForm" action="submission_gli.php">
      ...
      <table align="left" class="x1">
        ...
        <tr> 
          ...
          <td><span class="style6">:</span></td>
          <td><input name="bagi" type="text" id="bagi"  maxlength="3" class="required " title="Bagi per Bulan harus diisi" value="<?=$bagi?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td><input type="text" name="tgl_akhir" id="tgl_akhir" size="10" class="required" title="Harap Mengisi Akhir Periode Dahulu" <? if($_GET['id']<>""){?> value="<?=baliktglindo($tgl_akhir)?>" <? }?>/>
